...
const StatusHeader = ({ cookies, cps, numberFormat, hasTempBuff, hasTempDebuff }) => (
  <nav className="flex gap-6 justify-between px-4 py-1 bg-white border-b shrink-0 border-slate-200">
    <div>
      ...
      <span className="inline-flex gap-1 items-center font-mono text-slate-700">
        {formatLargeNumber(cookies, numberFormat)}

        {hasTempBuff && <span className="text-yellow-500"><FontAwesomeIcon icon={faStar} /></span>}
        {hasTempDebuff && <span className="text-red-500"><FontAwesomeIcon icon={faExclamationTriangle} /></span>}
      </span>
    </div>
    <div>
